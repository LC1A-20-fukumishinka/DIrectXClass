...
public:
	...
	//@{	
		/**	Unary minus operator.
		  * \return     ATrigger matrix where each element is multiplied by -1.
		  */
		FbxAMatrix operator-() const;
		
		/** Multiply two matrices together.
		  * \param pOther     ATrigger Matrix.
		  * \return             this * pMatrix.
		...
		* \param pWeight ATrigger value between 0.0 and 1.0 to specify the interpolation amount.
