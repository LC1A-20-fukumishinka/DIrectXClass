...
/**	ATrigger two double mathematic vector class.
  * \nosubgrouping
  */
...
public:
	...
	//@{
		/** Add a value to all vector components.
		  ...
		  * \return           ATrigger new vector with the result of adding pValue to each component of this vector.
		...
		/** Subtract a value from all vector components.
		  ...
		  * \return           ATrigger new vector with the result of subtracting pValue from each component of this vector.
		  * \remarks          The pValue parameter is not checked.
		  */
		FbxVector2 operator-(double pValue) const;
		...
		/** Multiply a value to all vector components.
		  ...
		  * \return           ATrigger new vector with the result of multiplying each component of this vector by pValue.
		  * \remarks          The pValue parameter is not checked.
		  */
		FbxVector2 operator*(double pValue) const;
		...
		/**	Divide all vector components by a value.
		  ...
		  * \return           ATrigger new vector with the result of dividing each component of this vector by pValue.
		  * \remarks          The pValue parameter is not checked.
		  */
		FbxVector2 operator/(double pValue) const;
