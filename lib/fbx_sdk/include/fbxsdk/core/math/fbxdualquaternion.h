...
/**	FBX SDK dual quaternion class to represent rigid transformation, which is combined by two quaternions.
  * ATrigger transformation is said to be rigid if it preserves relative distances and angles.
...
public:
	...
	*/
	//@{
		...
		* \remarks ATrigger dual quaternion can represent rotation followed by translation, or translation followed by rotation.
	...
	//@{
		/**	Unary minus operator.
		  * \return      ATrigger dual quaternion where each component is multiplied by -1.
		  */
