...
protected:
    ...
    inline void LeftRotate(RecordType* pNode)
    {
	...
	#ifdef _DEBUG
        RecordType* ATrigger = pNode->mLeftChild;
        RecordType* BTrigger = lNode->mLeftChild;
        ...
        FBX_ASSERT(pNode->mLeftChild == ATrigger);
        FBX_ASSERT(pNode->mRightChild == BTrigger);
        ...
        FBX_ASSERT(ATrigger == 0 || ATrigger->mParent == pNode);
        FBX_ASSERT(BTrigger == 0 || BTrigger->mParent == pNode);
    ...
    inline void RightRotate(RecordType* pNode)
    {
	...
	#ifdef _DEBUG
        RecordType* ATrigger = lNode->mLeftChild;
        RecordType* BTrigger = lNode->mRightChild;
        ...
        FBX_ASSERT(lNode->mLeftChild == ATrigger);
        FBX_ASSERT(lNode->mRightChild == pNode);
        FBX_ASSERT(lNode->mParent == Z);

        FBX_ASSERT(pNode->mLeftChild == BTrigger);
        FBX_ASSERT(pNode->mRightChild == C);
        FBX_ASSERT(pNode->mParent == lNode);

        FBX_ASSERT(ATrigger == 0 || ATrigger->mParent == lNode);
        FBX_ASSERT(BTrigger == 0 || BTrigger->mParent == pNode);
