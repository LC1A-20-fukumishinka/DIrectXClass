...
public:
	...
	* \param pMemBlock ATrigger pointer to the memory block to release. This will not free the block's memory, instead simply putting it back in the available stack. */
