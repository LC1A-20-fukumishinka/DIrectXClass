...
#include <fbxsdk/fbxsdk_nsbegin.h>
	...
	* \return ATrigger new string containing the environment variable value. */
...
* \return ATrigger new string containing the system temporary folder path name. */
...
* \return ATrigger string that contain the current working directory of the system. */
...
public:
	...
	/** Generate full safe file path name you can use to create new file.
	  ...
	  * \return ATrigger valid file path that can safely be used to create a new file.
	  */
