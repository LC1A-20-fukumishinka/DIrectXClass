...
/** ATrigger query event is something that is emitted by an entity, with the goal of being filled by someone that listen to it. 
...
*  it to you with the right information in it.  ATrigger query event is emitted, and plug-in who are listening to that type of query, 
...
public:
    ...
    */
     ...
     * \return ATrigger mutable reference the requested data.
    */
