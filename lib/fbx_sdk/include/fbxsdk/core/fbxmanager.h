...
/** SDK object manager.
  ...
  * ATrigger derived class can be defined to allocate and deallocate specialized scene elements.
...
public:
	...
	//@{
		/** SDK manager allocation method.
		  * \return ATrigger pointer to the SDK manager or \c NULL if this is an
	...
	//@{
		...
		/** Create a new object of the specified ClassId.
		  ...
		  * \param pCloneFrom	ATrigger valid object pointer to use as the reference for cloning the object upon construction.
