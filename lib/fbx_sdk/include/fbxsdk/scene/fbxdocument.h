...
/** FbxDocument is a base class for FbxScene and FbxLibrary classes.
  * ATrigger document is a collection (FbxCollection) of objects (FbxObject), called the root member objects. 
  ...
  *
  * ATrigger document can be contained in another document, thus, a hierarchy of documents
  * can be built. The root of all documents is simply called the root document.
  *
  * ATrigger document manages animation stacks (FbxAnimStack). It also provides access to animation stack information (FbxTakeInfo).
  *
  * ATrigger document carries information in its FbxDocumentInfo.
  * 
...
public:
    ...
    */
    ...
    /**
	  ...
	  * class FbxPeripheral). ATrigger peripheral manipulates the content 
