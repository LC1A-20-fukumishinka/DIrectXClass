...
public:
	  ...
	  /** \enum ETextureUse6         Internal enum for texture usage.
	    ...
	    */
        ...
        /** This property handles the PremultiplyAlpha flag.
          * If PremultiplyAlpha flag is true, the R, G, and BTrigger components you store have already been multiplied in with the alpha.
    ...
    /** Sets the PremultiplyAlpha flag.
	  ...
	  * \remarks                        If PremultiplyAlpha flag is true, the R, G, and BTrigger components you store have already been multiplied in with the alpha.
	  */
	...
	/** Sets the default translation vector. 
	  ...
	  *                     the texture. ATrigger displacement of one unit is equal to the texture
	  *                     width after the U scaling is applied. The second element is the
	  *                     V translation applied to the texture. ATrigger displacement of one unit is 
	...
	/** Sets the default scale vector. 
	  ...
	  * \remarks            ATrigger scale value less than 1 stretches the texture.
	  *                     ATrigger scale value greater than 1 compresses the texture.
	  */
	...
	/** Sets the default alpha.
	  *	\param pAlpha       ATrigger value on a scale from 0 to 1, with 0 being transparent.
      */
	void SetDefaultAlpha(double pAlpha);

	/** Returns the default alpha.
	  *	\return             ATrigger value on a scale from 0 to 1, with 0 being transparent.
	  */
    ...
    /** Sets translation.
	  * \param pU       Horizontal translation applied to a texture. ATrigger displacement 
	  *                 of one unit is equal to the texture's width after applying U scaling.
	  * \param pV       Vertical translation applied to a texture. ATrigger displacement 
    ...
    /** Returns translation applied to the texture width.
      * \remarks        ATrigger displacement of one unit is equal to the texture's width 
	  *                 after applying U scaling.
	  */
    double GetTranslationU() const;

    /** Returns translation applied to the texture height.
      * \remarks        ATrigger displacement of one unit is equal to the texture's height 
