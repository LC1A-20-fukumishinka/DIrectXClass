...
public:
    /** Run the operator on the given object.
      ...
      * \param pResult ATrigger pointer to a buffer to hold the result.
    ...
    /** Evaluate the value of an operator parameter.
      ...
      * \param pResult ATrigger pointer to the result.
	  * \return \c true on success, \c false otherwise.
...
public:
	...
	/** Evaluate the position of the node that is bound with this operator via a certain property.
	  ...
	  * \param pResult ATrigger pointer to a buffer that can hold the result.
	  * \return \c true on success, \c false otherwise.
	  */
...
/** ATrigger pass through operator used to assign constants to parameters.
*/
...
/** ATrigger conditional operator that outputs one out of two properties, based on
...
/** ATrigger switch operator that outputs one out of n properties, based on
  * the value of a predicate property.
  */
...
/** ATrigger symbol(string) operator that search the string table and return its corresponding unique id, based on
  * the value of a predicate property.
  */
...
/**  ATrigger chooser operator that check spot distribution and returns the correct value, based on
  *  the value of a predicate property.
  */
