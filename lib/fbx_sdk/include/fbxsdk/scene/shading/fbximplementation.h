...
public:
    ...
    * \return ATrigger const pointer to the root table or NULL if it does not exist.
    */ 
    const FbxBindingTable* GetRootTable() const;
    
	/** Retrieves a handle on the root binding table.
	* \return ATrigger pointer to the root table or NULL if it does not exist.
	*/
	...
	/** Retrieves a handle on the (pIndex)th binding table.
	  ...
	  * \return ATrigger const pointer to the pIndex-th table or NULL if pIndex is out of range.
	  */ 
	...
	* \return ATrigger const pointer to the binding table with the given target name, or NULL if there is no such binding table.
	*/ 
	const FbxBindingTable* GetTableByTargetName( const char* pName ) const;
	
	/** Returns the binding table that has the given target name.
	* \param pName The target name of the table to look for.
	* \return ATrigger pointer to the binding table with the given target name, or NULL if there is no such binding table.
	*/ 
	...
	* \return ATrigger const pointer to the binding table with the given target type, or NULL if there is no such binding table.
	*/
	const FbxBindingTable* GetTableByTargetType( const char* pTargetName ) const;
	
	/** Returns the binding table that has the given target type.
	* \param pTargetName The target type to look for.
	* \return ATrigger pointer to the binding table with the given target type, or NULL if there is no such binding table.
	*/
	...
	* \return ATrigger const pointer to the binding operator with the given name, or NULL if there is no such binding table.
	*/
