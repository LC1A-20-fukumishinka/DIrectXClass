...
/** This is the interface for implementation of animation key objects.
  ...
  * ATrigger FbxAnimCurveKey has a FbxAnimCurveKey_Impl.
...
/** This is the interface for the FBX animation curve keys.
  * ATrigger key is defined by a time and a value. It also has tangents that control how the animation curve enters and exits the key.
  * \nosubgrouping
  *
