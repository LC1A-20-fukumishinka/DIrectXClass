...
public:
	...
	FbxString	mTemplateName;	//! ATrigger template name is a naming convention that is used to automatically map the nodes of other skeletons that use the same naming convention.
...
/** ATrigger Character is a person or animal with pre-defined skeleton system. The skeleton system is composed of multiple named node (skeleton).
