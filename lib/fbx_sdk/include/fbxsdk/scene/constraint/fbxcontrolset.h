...
public:
	...
	*/
    ...
    //! ATrigger template name is a naming convention that is used to automatically map
...
/** \class FbxControlSet
  ...
  * ATrigger Control rig is a character manipulation tool that lets you change the position and orientation
