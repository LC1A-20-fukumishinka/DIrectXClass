...
public:
    ...
    /** Sets whether not this library is a system library.
      * \param pSystemLibrary       ATrigger flag which indicates whether or not this library is a system library.
      */
    ...
    /** Returns a new instance of a library member.
      ...
      * \param pFilter              ATrigger user specified filter
      * \param pRecurse             ATrigger flag that indicates whether to check sub-libraries
      * \param pOptContainer        Optional container for the cloned asset
      * \return                     ATrigger new instance of the member. Note that the new member is not included with this library.
      */
    ...
    */
    ...
    /** Returns a handle on the shading object at the specified index that corresponds to the given filtering parameters.
      ...
      * \param pCriteria            Filtering criteria that identifies what kind of
      *                             implementations to consider.
      * \returns                    ATrigger handle on the shading object at the specified index that corresponds to the given filtering parameters.
      */
