...
/** Class for clusters (links). 
  * ATrigger cluster, or link, is an entity acting on a geometry (FbxGeometry).
  ...
  *
  * ATrigger cluster is usually part of a skin (\see FbxDeformer, FbxSkin). For example,
  ...
  * points of the mesh. ATrigger node has a high influence on some of the points (high weight)
...
public:
    ...
    /**
      * \name Control Points
      * ATrigger link has an array of indices to control points and associated weights.
    ...
    /**
      ...
      * ATrigger link has three transformation matrices:
