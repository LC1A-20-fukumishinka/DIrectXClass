...
/** Represents an element in the scene graph. ATrigger scene graph is a tree of FbxNode 
...
public:
	...
	/**
	  ...
	  * uses its X axis as the aiming constraint. ATrigger rotation offset can be added to change 
	...
	//@{
		/** Set the node attribute.
		  ...
		  * \remarks ATrigger node attribute can be shared between nodes.
	...
	/**
	  ...
	  * ATrigger node has two pivot contexts defined by the EPivotSet enumeration. The node's animation 
