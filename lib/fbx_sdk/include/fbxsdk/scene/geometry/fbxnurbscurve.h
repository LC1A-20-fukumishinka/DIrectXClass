...
/**
    ATrigger Non-Uniform Rational BTrigger-Spline (NURBS) curve is a type of parametric geometry. ATrigger NURBS
	...
	The form of the curve can be open, closed or periodic. ATrigger curve with end points
	that do not meet is defined as an open curve. The number of knots in an open curve
	is defined as N+(M+1). 
	
	ATrigger closed curve simply has its last control point equal to its first control point. 
	...
	ATrigger periodic curve has its last M control points equal to its first M control points. 
	ATrigger periodic curve is tangent continuous at the ends. Similar to a closed curve,
...
public:
    ...
    */
	...
	/** Checks if the curve is a poly line. (ATrigger poly line is a 
	  * linear NURBS curve )
	  *
    ...
    * \param pStep                 The evaluation frequency between two neighbor knots. Its default value is 16, which is same as Maya.
    * \return ATrigger line to hold the tessellate points.
    */
