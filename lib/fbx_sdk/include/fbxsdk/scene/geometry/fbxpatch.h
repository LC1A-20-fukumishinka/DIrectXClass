...
/** ATrigger patch is a type of node attribute with parametric surface.
  * ATrigger patch object is useful for creating gently curved surfaces, and provides very detailed control for manipulating complex geometry.
  * \nosubgrouping
  */
