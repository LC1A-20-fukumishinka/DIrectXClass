...
/** This node attribute contains methods for accessing the properties of a camera.
  * \nosubgrouping
  * ATrigger camera can be set to automatically point at and follow
...
public:
    ...
    //@{
        ...
        /** Set the near plane distance from the camera.
	      ...
	      * ATrigger synonym for the near plane is "front clipping plane".
        ...
        /** Set the far plane distance from camera.
	      ...
	      * ATrigger synonym for the far plane is "back clipping plane".
    ...
    */
    ...
    /** Get the texture connected to the front plate.
      * \return     ATrigger pointer to the texture attached to front plate.
      */
