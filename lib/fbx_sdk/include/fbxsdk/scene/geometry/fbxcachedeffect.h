...
/** ATrigger cached effect is a type of node attribute to represent certain type of effect 
...
public:
	...
	/** Get the cache object used by this node attribute.
	  * \return     ATrigger pointer to the cache object used by this node attribute, or \c NULL if no cache object is assigned.
	  */
