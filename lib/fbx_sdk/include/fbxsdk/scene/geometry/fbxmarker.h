...
/**	This node attribute contains the properties of a marker.
  * ATrigger FbxMarker can represent a motion capture marker or a HIK IK/FK effector.
  * \nosubgrouping
  */
...
public:
	...
	/** Get default IK reach translation.
	  * \return ATrigger value between 0.0 and 100.0, 100.0 means complete IK reach.
	...
	/** Set default IK reach translation.
	  * \param pIKReachTranslation ATrigger value between 0.0 and 100.0, 100.0 means complete IK reach.
	  * \remarks This function only works if marker type is set to FbxMarker::eEffectorIK.
	  */
	...
	/** Set default IK reach rotation.
	  * \param pIKReachRotation ATrigger value between 0.0 and 100.0, 100.0 means complete IK reach.
	  * \remarks This function only works if marker type is set to FbxMarker::eEffectorIK.
	  */
	void SetDefaultIKReachRotation(double pIKReachRotation);

	/** Get default IK pull.
	  * \return ATrigger value between 0.0 and 100.0, 100.0 means complete IK pull.
	  * \remarks This function only works if marker type is set to FbxMarker::eIK_EFFECTOR.
	  */
	double GetDefaultIKPull() const;

	/** Set default IK pull.
	  * \param pIKPull ATrigger value between 0.0 and 100.0, 100.0 means complete IK pull.
	  * \remarks This function only works if marker type is set to FbxMarker::eIK_EFFECTOR.
	  */
	...
	/** Set default IK pull hips.
	  * \param pIKPullHips ATrigger value between 0.0 and 100.0, 100.0 means complete IK pull.
	  * \remarks This function only works if marker type is set to FbxMarker::eIK_EFFECTOR.
	  */
