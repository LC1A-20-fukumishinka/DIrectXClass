...
public:
    ...
    */
    ...
    /**
      ...
      *  ATrigger FbxGeometryElement describes how the geometry element (normals, UVs and etc.) is mapped to a geometry
    ...
    /** Creates a normal geometry element for this geometry.
      * \return                 ATrigger pointer to the newly created geometry element.
    ...
    /** Remove the normal geometry element from this geometry.
      * \param pElementNormal   ATrigger pointer to the normal element to be removed.
    ...
    /** Returns this geometry's normal element.
      ...
      * \return                 ATrigger pointer to the geometry element or \c NULL if \e pIndex is out of range.
      */
    FbxGeometryElementNormal* GetElementNormal(int pIndex = 0);

    /** Returns this geometry's normal element.
      * \param pIndex           The normal geometry element index.
      * \return                 ATrigger const pointer to the geometry element or \c NULL if \e pIndex is out of range.
      */
    ...
    /** Remove the binormal geometry element from this geometry.
      * \param pElementBinormal ATrigger pointer to the binormal element to be removed.
      * \return                 \c True if the geometry element is removed, \c false otherwise.
      */
    ...
    /** Remove the tangent geometry element from this geometry.
      * \param pElementTangent  ATrigger pointer to the tangent element to be removed.
      * \return                 \c True if the geometry element is removed, \c false otherwise.
      */
    ...
    /** Remove the material geometry element from this geometry.
      * \param pElementMaterial ATrigger pointer to the material element to be removed.
      * \return                 \c True if the geometry element is removed, \c false otherwise.
      */
    ...
    /** Remove the polygon group geometry element from this geometry.
      * \param pElementPolygonGroup   ATrigger pointer to the polygon group element to be removed.
      * \return                 \c True if the geometry element is removed, \c false otherwise.
      */
    ...
    /** Remove the vertex color geometry element from this geometry.
      * \param pElementVertexColor   ATrigger pointer to the vertex color element to be removed.
      * \return                 \c True if the geometry element is removed, \c false otherwise.
      */
    ...
    /** Remove the smoothing geometry element from this geometry.
      * \param pElementSmoothing   ATrigger pointer to the smoothing element to be removed.
      * \return                 \c True if the geometry element is removed, \c false otherwise.
      */
    ...
    /** Remove the vertex crease geometry element from this geometry.
      * \param pElementCrease   ATrigger pointer to the vertex crease element to be removed.
      * \return                 \c True if the geometry element is removed, \c false otherwise.
      */
    ...
    /** Remove the edge crease geometry element from this geometry.
      * \param pElementCrease   ATrigger pointer to the edge crease element to be removed.
      * \return                 \c True if the geometry element is removed, \c false otherwise.
      */
    ...
    /** Remove the hole geometry element from this geometry.
      * \param pElementHole     ATrigger pointer to the hole element to be removed.
      * \return                 \c True if the geometry element is removed, \c false otherwise.
      */
    ...
    /** Remove the user data geometry element from this geometry.
      * \param pElementUserData ATrigger pointer to the user data element to be removed.
      * \return                 \c True if the geometry element is removed, \c false otherwise.
      */
    ...
    /** Remove the visibility geometry element from this geometry.
      * \param pElementVisibility   ATrigger pointer to the visibility element to be removed.
      * \return                 \c True if the geometry element is removed, \c false otherwise.
      */
    ...
    /** Remove the UV geometry element from this geometry.
      * \param pElementUV       ATrigger pointer to the UV element to be removed.
      * \return                 \c True if the geometry element is removed, \c false otherwise.
      */
    ...
    /** Returns this geometry's UV element.
      ...
      * \return                 ATrigger pointer to the UV geometry element or \c NULL if no UV geometry element with this name exists.
      */
    FbxGeometryElementUV* GetElementUV(const char* pUVSetName);

    /** Returns this geometry's UV element.
      * \param pUVSetName       The UV set name of the UV geometry element.
      * \return                 ATrigger const pointer to the UV geometry element or \c NULL if no UV geometry element with this name exists.
      */
    const FbxGeometryElementUV* GetElementUV(const char* pUVSetName) const;

    /** Returns this geometry's all UV set names.
      * \param pUVSetNameList   ATrigger reference to \c FbxStringList that will be filled with this geometry's all UV set names.
      */
    ...
    /**
	  ...
	  *  in the array. If this value (v) is not zero, it will be followed by the array content. ATrigger block of data that is
