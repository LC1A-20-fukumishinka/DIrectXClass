...
/** Base class for skin deformer (FbxSkin) and vertex cache deformer (FbxVertexCacheDeformer).
  ...
  * ATrigger deformer can be binded to a geometry (FbxGeometry) to act on its shape. Typically,
  * some objects under the deformer are animated, and via the deformer, the geometry
  * is animated too.
  *
  * ATrigger skin deformer contains clusters (FbxCluster). Each cluster acts on a subset of the geometry's
  ...
  * animate it too.
  *
  * ATrigger vertex cache deformer contains a cache (FbxCache). The cache contains animation
