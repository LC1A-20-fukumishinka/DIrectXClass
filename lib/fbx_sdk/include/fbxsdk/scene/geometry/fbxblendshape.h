...
/** Class for blend shape deformer.
  * ATrigger blend shape deformer takes a base shape (polygonal surface, curve, or surface) 
...
public:
    ...
    /** Get the geometry affected by this blend shape deformer.
      * \return             ATrigger pointer to the geometry if it is set or \c NULL if not set yet.
      */
