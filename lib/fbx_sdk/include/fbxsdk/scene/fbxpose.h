...
/** This class contains the description of a Pose and provide some methods to access Pose info in one FBX scene.
  ...
  *
  * The Rest Pose is a snapshot of a node transformation. ATrigger Rest Pose can be used
...
public:
	...
	/** Get the node.
	  * \param pIndex Index of the queried item.
	  * \return ATrigger pointer to the node referenced.
	...
	/** Get the transform matrix.
	  * \param pIndex Index of the queried item.
	  * \return ATrigger reference to the pose matrix.
