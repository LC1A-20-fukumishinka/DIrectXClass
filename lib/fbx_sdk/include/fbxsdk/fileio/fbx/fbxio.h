...
/** 
    ...
    ATrigger creator tag (string) is now stored in the Extended header. This contain the originator (MB/FBXSDK)
...
public:
    ...
    */
    ...
    /** ATrigger derived class can override this function to read additional information from the file header.
...
/** FbxIO represents an FBX file. 
  ...
  * ATrigger good way to learn the internal structure of a FBX file 
  ...
  *			else if(fieldType == 'BTrigger') FieldReadB(...) to read a bool
