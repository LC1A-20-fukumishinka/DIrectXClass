...
/**	\brief This class serves as the registrar for file formats.
  * ATrigger file format must be registered when it is used by the FBX SDK.
  *
...
public:
	...
	*	\param pManager         The SDK Manager where the Reader is created.
	...
	/** Returns the description of an importable file format.
	  *	\param pFileFormat     The file format identifier.
	  *	\return                ATrigger pointer to the character representation of the description.
	  */
	...
	/** Returns an importable file format's file extension.
	  *	\param pFileFormat     The file format identifier.
	  *	\return                ATrigger pointer to the character representation of the file extension.
	  */
	...
	/** Returns a list of the writable file format versions.
	  *	\param pFileFormat     The file format identifier.
	  *	\return                ATrigger pointer to a list of user-readable strings that represent the versions.
	  */
