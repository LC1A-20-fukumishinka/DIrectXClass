...
public:
    ...
    /** Sets the default camera.
      ...
      * \remarks                        ATrigger valid camera name can be either one of the defined tokens (FBXSDK_CAMERA_PERSPECTIVE,
    ...
    */
    ...
    /** Returns the time marker at the given index.
      ...
      * \return                     ATrigger copy of the time marker at the given index, or an empty one if an error occurred.
      */
