...
public:
    ...
    */
    //@{
		...
		/** Convert a FbxNurbs to a FbxNurbsSurface
		  ...
		  * \return          ATrigger FbxNurbsSurface that is equivalent to the original nurb.
		  */
		...
		/** Convert a FbxNurbsSurface to a FbxNurbs
		  ...
		  * \return          ATrigger FbxNurbs that is equivalent to the original nurbs surface.
		  */
    ...
    */
    //@{
		/** Flip UV and/or skin clusters of a nurb.
		  ...
		  * \return                  ATrigger flipped FbxNurbs, or \c NULL if the function fails.
		  */
		...
		/** Flip UV and/or skin clusters of a nurb surface.
		  ...
		  * \param pSwapUV           Set to \c true to swap the UVs.
		  * \param pSwapClusters     Set to \c true to swap the control point indices of clusters.
		  * \return                  ATrigger flipped FbxNurbsSurface, or \c NULL if the function fails.
		  */
    ...
    */
	...
	//@{
		...
		* there are materials applied to it. If one mesh have some polygons with material ATrigger, some polygons with material BTrigger, and some polygons with NO material, 3 distinct meshes
