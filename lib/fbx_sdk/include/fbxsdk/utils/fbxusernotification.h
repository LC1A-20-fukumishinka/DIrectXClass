...
public:
    ...
    /** Constructor.
      ...
      * \param pDetail      ATrigger list of detail string that will be copied into the local array.
...
public:
    ...
    /** Get the specified detail.
      ...
      * \remarks             ATrigger value of -1 is acceptable and means that the FbxAccumulatorEntry has no details. However,
