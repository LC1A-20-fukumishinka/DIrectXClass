...
#pragma region VShader
	result = D3DCompileFromFile(
		L"Resources/shaders/MonochromeVS.hlsl",//シェーダファイル名
		nullptr,
...
#pragma region PShader
	result = D3DCompileFromFile(
		L"Resources/shaders/MonochromePS.hlsl",//シェーダファイル名
		nullptr,
		D3D_COMPILE_STANDARD_FILE_INCLUDE,//インクルード可能にする
...
const PipeClass::PipelineSet &PostMonochromePipeline::GetPipeLine()
{
	return pipelineSet;
}
