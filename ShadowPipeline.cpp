...
ShadowPipeline::ShadowPipeline()
{
	...
	pipelineDesc.VSname = L"Resources/shaders/ShadowVS.hlsl";
	pipelineDesc.PSname = L"Resources/shaders/ShadowPS.hlsl";
...
PipeClass::PipelineSet *ShadowPipeline::GetPipeLine()
{
	return pipelineSet.get();
}

ShadowPipeline *ShadowPipeline::Instance()
{
