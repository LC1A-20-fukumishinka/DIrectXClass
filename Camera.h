...
public:
	...
	Camera();
	void Init(const DirectX::XMFLOAT3 &eye = { 0, 0, -100 }, const  DirectX::XMFLOAT3 &target = { 0, 0, 0 }, const  DirectX::XMFLOAT3 &up = { 0, 1, 0 }, bool isPerspective = true, const Projection::ProjectionData &projectionData = Projection::ProjectionData());
	void Update();
