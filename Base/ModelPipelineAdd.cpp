...
ModelPipelineAdd::ModelPipelineAdd()
{
	...
	pipelineDesc.blendName = BlendName::ADD;
...
PipeClass::PipelineSet *ModelPipelineAdd::GetPipeLine()
{
	return pipelineSet.get();
}

ModelPipelineAdd *ModelPipelineAdd::Instance()
{
